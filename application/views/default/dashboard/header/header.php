...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title><?php echo $this->config->item('sitename'); ?> | Dashboard</title>
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid page-md"  id="scrollable_container">
      ...
      <!--<img src="<?= $this->config->item('adminassets'); ?>layouts/layout2/img/logo-default.png" alt="logo" class="logo-default" />--> </a>
