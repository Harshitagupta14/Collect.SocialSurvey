    ...
    <div class="page-content" id="card_view_container">
        ...
        <div class="tabbable-line">
            <ul class="nav nav-tabs ">
                <li class="active">
                    <a href="#tab_survey" data-toggle="tab" aria-expanded="true">Survey</a>
                </li>
                <li class="">
                    <a href="#tab_profile" data-toggle="tab" aria-expanded="false">Profile</a>
                </li>
                <li class="">
                    <a href="#tab_settings" data-toggle="tab" aria-expanded="false">Settings</a>
                </li>
            </ul>
