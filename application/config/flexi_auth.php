 ...
 */
$config['security']['recaptcha_public_key'] = '6Le0VQATAAAAAK5DK4hbW2Rq_UgIV03vhgbWNOrW';
$config['security']['recaptcha_private_key'] = '6Le0VQATAAAAANFIxXqY0uzsD2XZRt3p6a1ZoM_m';
 ...
 */
$config['email']['email_template_directory'] = 'email_templates/';
...
$config['messages']['delimiters']['status_prefix'] = '<div class="alert alert-success" role="alert"><p class="text-primary">';

// Message End Delimiter
$config['messages']['delimiters']['status_suffix'] = '</p></div>';

// Error Start Delimiter
$config['messages']['delimiters']['error_prefix'] = '<div class="alert alert-danger" role="alert"><p class="text-primary">';

// Error End Delimiter
$config['messages']['delimiters']['error_suffix'] = '</p></div>';
...
//User Type
$config['messages']['target_user']['account_type'] = 'public';
