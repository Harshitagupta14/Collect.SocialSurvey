...
$config['base_url'] = 'http://localhost/Collect.SocialSurvey/';
...
$config['sitename'] = 'Collect - SocialEverest';
$config['template'] = 'default';
$config['adminFolder'] = 'admin';

//Template Files
$config['public_folder_name'] = 'default';
$config['admin_folder_name'] = 'admin';

//login system urls
$config['login_url'] = 'login';
$config['admin_url'] = 'login';
$config['admin_login_url'] = 'admin';
$config['public_login_url'] = 'account';
$config['login_folder'] = 'account';
$config['public_login_folder'] = 'account_public';
$config['admin_login_folder'] = 'account_admin';
/*
  |--------------------------------------------------------------------------
  | Index File
  |--------------------------------------------------------------------------
